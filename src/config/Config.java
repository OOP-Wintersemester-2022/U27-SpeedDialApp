...
public final class Config {
    ...
    public static final Color APP_BACKGROUND_COLOR = new Color(40, 44, 52);
     ...
     * List
     **/
    public static final Color PHONEBOOK_ENTRY_BACKGROUND_COLOR = new Color(86, 182, 194);
    public static final Color PHONEBOOK_FONT_COLOR = new Color(250, 250, 250, 255);
    public static final int NAME_LABEL_FONT_SIZE = 24;
    public static final int INFORMATION_LABEL_FONT_SIZE = 12;
